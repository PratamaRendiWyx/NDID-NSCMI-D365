page 50304 "Posted DO Lines"
{
    ApplicationArea = All;
    Caption = 'Posted DO Lines';
    PageType = List;
    SourceTable = "Posted DO Line";
        ...
        area(navigation)
        {
            group("&Line")
            {
                ...
                action("Show Document")
                {
                    ...
                    trigger OnAction()
                    begin
                        postedDOHeader.Get(Rec."Document No.");
                        PAGE.Run(PAGE::"Posted Vendor DO", postedDOHeader);
                    end;
                }
            }
        }
