report 50401 "BOP Type 2 New"
{
    Caption = 'Print BOP';
    DefaultLayout = RDLC;
    RDLCLayout = './ReportDesign/BOP Type2 New.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Item Ledger Entry"; "Item Ledger Entry")
        {
            ...
            */
            ...
            column(Standard10; getItemAttribute('BOP - Joint A')) { }
            column(Standard11; getItemAttribute('BOP - Joint T')) { }
            column(Standard12; getItemAttribute('BOP - Joint Z')) { }
            column(Standard13; getItemAttribute('BOP - BS - XZ')) { }
            column(Standard14; getItemAttribute('BOP - BS - T')) { }
            //-
