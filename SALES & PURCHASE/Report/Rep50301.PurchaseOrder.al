report 50301 "Purchase Order"
{
    Caption = 'Purchase Order';
    DefaultLayout = RDLC;
    RDLCLayout = './ReportDesign/PurchaseOrder CAPSLOCK.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(PrepaymentBool; flagPrepaymentBool()) { }
    ...
    local procedure flagPrepaymentBool(): Boolean
    begin
        if "Purchase Header"."Prepayment %" > 0 then
            exit(true)
        else
