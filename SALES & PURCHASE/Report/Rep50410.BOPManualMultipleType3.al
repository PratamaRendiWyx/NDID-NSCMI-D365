report 50410 "BOPManualMultipleType3"
{
    Caption = 'Print BOP Manual Multiple Type 3';
    DefaultLayout = RDLC;
    RDLCLayout = './ReportDesign/BOPManualMultipleType3.rdlc';
    ApplicationArea = All;
                ...
                dataitem(QualityTestHeader_PQ; QualityTestHeader_PQ)
                {
                    ...
                    dataitem(QualityTestLines_PQ; QualityTestLines_PQ)
                    {
                        ...
                        begin
                            ...
                            currDat := QualityTestHeader_PQ."Lot No./Serial No." + '#' + Format("Sampling to");
