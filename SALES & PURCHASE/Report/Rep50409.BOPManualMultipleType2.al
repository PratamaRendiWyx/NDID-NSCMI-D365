report 50409 "BOPManualMultipleType2"
{
    Caption = 'Print BOP Manual Multiple Type 2';
    DefaultLayout = RDLC;
    RDLCLayout = './ReportDesign/BOPManualMultipleType2.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(BOPManualHeader; "BOPManualHeader_SP")
        {
            ...
            column(glbCustomer; getCustomerName('', "Customer Name")) { }
            ...
            dataitem(BOPManualTracking; "BOPManualTracking_SP")
            {
                ...
                column(Standard10; getItemAttribute("Item No.", 'BOP - Joint A')) { }
                column(Standard11; getItemAttribute("Item No.", 'BOP - Joint T')) { }
                column(Standard12; getItemAttribute("Item No.", 'BOP - Joint Z')) { }
                column(Standard13; getItemAttribute("Item No.", 'BOP - BS - XZ')) { }
                column(Standard14; getItemAttribute("Item No.", 'BOP - BS - T')) { }
                ...
                dataitem(QualityTestHeader_PQ; QualityTestHeader_PQ)
                {
                    ...
                    dataitem(QualityTestLines_PQ; QualityTestLines_PQ)
                    {
                        ...
                        column(Display20; getValueQT(QualityTestHeader_PQ."Test No.", QualityTestLines_PQ."Sampling to", 20)) { }
                        column(Display21; getValueQT(QualityTestHeader_PQ."Test No.", QualityTestLines_PQ."Sampling to", 21)) { }
                        column(Display22; getValueQT(QualityTestHeader_PQ."Test No.", QualityTestLines_PQ."Sampling to", 22)) { }
                        column(Display23; getValueQT(QualityTestHeader_PQ."Test No.", QualityTestLines_PQ."Sampling to", 23)) { }
                        column(Display24; getValueQT(QualityTestHeader_PQ."Test No.", QualityTestLines_PQ."Sampling to", 24)) { }
