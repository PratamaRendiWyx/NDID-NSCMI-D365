codeunit 50713 WhereUsedManagement_PQ
{
    ...
    local procedure BuildWhereUsedList(Type: Option " ",Item,"Production BOM"; No: Code[20]; CalcDate: Date; Level: Integer; Quantity: Decimal; VariantCode: Code[10])
    var
        ...
        if Type = Type::"Production BOM" then begin
            ...
            if ItemAssembly.FindSet then
                repeat
                    ...
                    WhereUsedList."Variant Code" := VariantCode;
                    ...
                    WhereUsedList."Quantity Needed" :=
                      ...
                      UOMMgt.GetQtyPerUnitOfMeasure(
                        ...
                        VersionMgt.GetBOMUnitOfMeasure(
                          ...
                          VersionMgt.GetBOMVersion(ItemVariant."Production BOM No.", CalcDate, false)));
                    WhereUsedList."Version Code" := VersionMgt.GetBOMVersion(No, CalcDate, true);
                    WhereUsedList."Variant Code" := ItemVariant.Code;
                    WhereUsedList.Insert();
                    NextWhereUsedEntryNo := NextWhereUsedEntryNo + 1;
                    if MultiLevel then
                        BuildWhereUsedList(
