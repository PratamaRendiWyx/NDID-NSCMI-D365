codeunit 50716 "Whse. QC Management"
{
    procedure MainProcess(var UpdItemLotRec: Record "Item Jnl. Update Lot QC"; var iDimensionSetID: Integer)
    var
        MSG_ProcessComplete: TextConst ENU = 'Create reclass entries is completed.';
        UpdItemLotRecDel: Record "Item Jnl. Update Lot QC";
    ...
    procedure QC_CreateReclassLine(var UpdItemLotRec: Record "Item Jnl. Update Lot QC")
    var
    ...
    local procedure CreateNewItemJournalLine(var IJL: Record "Item Journal Line"; var UpdItemLotRec: Record "Item Jnl. Update Lot QC")
    var
    ...
    begin
        ...
        with IJL do begin
            ...
            "Document No." := UpdItemLotRec."Test No";
    ...
    local procedure CreateNewItemTrackingLine(var TrackingSpec: Record "Tracking Specification"; var IJL: Record "Item Journal Line"; var UpdItemLotRec: Record "Item Jnl. Update Lot QC")
    var
