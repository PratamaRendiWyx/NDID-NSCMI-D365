tableextension 50713 SerialNoInformation_PQ extends "Serial No. Information"
{
    ...
    fields
    {
        ...
        field(50702; "Non-Conformance"; Boolean)
        {
            ...
            CalcFormula = Exist(QualityTestLines_PQ WHERE("Item No." = FIELD(FILTER("Item No.")),
                                                                "Lot No./Serial No." = FIELD(FILTER("Serial No.")),
        ...
        field(50704; "CCS Expiration Date"; Date)
        {
            ...
            begin
                if "CCS Expiration Date" <> 0D then
                    FunctionLibrary.UpdateILEExpirationDateFromSerialNoInformation(Rec);
            end;
        }
        field(50705; "CCS Status"; Enum LotSerialStatus_PQ)
        {
            ...
            begin
                case "CCS Status" of
                    "CCS Status"::Hold, "CCS Status"::"In Quality Inspection":
