table 50726 "Item Jnl. Update Lot QC"
{
    Caption = 'Item Jnl. Update Lot QC';
    DrillDownPageID = UpdateItemLotQC_PQ;
    LookupPageID = UpdateItemLotQC_PQ;

    fields
    {
        field(1; "Test No"; Code[35])
        {
            Caption = 'Test No.';
        }
    ...
    keys
    {
        key(PK; "Test No", "Item No.", "Lot No.", "New Lot No.", "Location Code")
        {
            Clustered = true;
        }
    }
