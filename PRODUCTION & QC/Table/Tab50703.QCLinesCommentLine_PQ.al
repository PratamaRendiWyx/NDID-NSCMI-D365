table 50703 QCLinesCommentLine_PQ
{
    // version QC7

    Caption = 'Quality Comment Line';
    DataCaptionFields = "Item No.", "Customer No.", Type, "Version Code", "QC Line No.";

    fields
    {
        field(1; "Table Name"; Option)
        {
            OptionCaption = 'Quality Control Header,QC Lines,Quality Control Version';
            OptionMembers = "QC Header","QC Lines","QC Version";
        ...
        field(5; "QC Line No."; Integer)
        {
            Caption = 'Quality Line No.';
            Description = 'Add Table Rel';
            NotBlank = true;
            DataClassification = CustomerContent;
        }
    ...
    keys
    {
        key(Key1; "Table Name", "Item No.", "Customer No.", Type, "Version Code", "QC Line No.", "Line No.")
        {
        }
    }
