report 50700 SplitProductionOrder_PQ
{
    ...
    procedure setParameter(var iProductionOrder: Record "Production Order")
    begin
        productionOrder1 := iProductionOrder;
        v_remainQty := iProductionOrder.Quantity;
    end;
