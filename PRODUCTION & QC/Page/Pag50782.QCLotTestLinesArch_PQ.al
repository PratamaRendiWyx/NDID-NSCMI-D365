page 50782 QCLotTestLinesArch_PQ
{
    // version QC10.1
    ...
    AutoSplitKey = true;
    Caption = 'Quality Lot Test Lines Archived';
    PageType = ListPart;
    SourceTable = QualityTestLinesArch_PQ;
    Editable = false;
    ...
    var
        QualSpecComment: Record QCTestLineCommentArch_PQ;
    begin
        QualSpecComment.SETRANGE("Test No.", Rec."Test No.");
        QualSpecComment.SETRANGE("Test Line", Rec."Line No.");
        PAGE.RUN(PAGE::QCTestLineCommentsArch_PQ, QualSpecComment);
    end;
