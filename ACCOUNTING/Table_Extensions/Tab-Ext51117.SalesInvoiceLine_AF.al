...
tableextension 51117 SalesInvoiceLine_AF extends "Sales Invoice Line"
{
    fields
    {
        ...
        field(51108; "Is Exists Cr. Memo"; Boolean)
        {
            Caption = 'Is Exists Cr. Memo (?)';
            FieldClass = FlowField;
            CalcFormula = exist("Sales Cr.Memo Header" where("Applies-to Doc. No." = field("Document No."), "Applies-to Doc. Type" = const(Invoice)));
            Editable = false;
        }
