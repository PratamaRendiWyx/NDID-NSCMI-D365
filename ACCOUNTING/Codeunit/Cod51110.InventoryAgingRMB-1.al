codeunit 51110 "Inventory Aging RMB-1"
{
    trigger OnRun()
    var
        myInt: Integer;
    ...
    begin
        ...
        begin
            ...
            InventoryAgingMgt.insertLog(LastDate, 5, 'Start Process Invt. Aging - RMB-1');
            item.Reset();
            ...
            InventoryAgingMgt.insertLog(LastDate, 5, 'End Process Invt. Aging - RMB-1');
        end;
    end;
