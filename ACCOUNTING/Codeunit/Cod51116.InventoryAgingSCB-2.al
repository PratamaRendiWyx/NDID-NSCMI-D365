codeunit 51116 "Inventory Aging SCB-2"
{
    trigger OnRun()
    var
        myInt: Integer;
    ...
    begin
        ...
        begin
            ...
            InventoryAgingMgt.insertLog(LastDate, 6, 'Start Process Invt. Aging - SCB-2');
            item.Reset();
            ...
            InventoryAgingMgt.insertLog(LastDate, 6, 'End Process Invt. Aging - SCB-2');
        end;
    end;
