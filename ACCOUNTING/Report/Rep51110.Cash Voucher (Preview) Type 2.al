report 51110 "Cash Voucher (Preview) Type 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportDesign/Cash Voucher (Preview) Type 2.rdlc';
        ...
        dataitem(GLHeader; "Gen. Journal Line")
        {
            ...
            dataitem("Gen. Journal Line"; "Gen. Journal Line")
            {
                ...
                begin
                    ...
                    if (StrLen("Gen. Journal Line".Description) > 46) OR (StrLen("Gen. Journal Line"."Account Name") > 36) then
                        LineCount += 2
                    else
                        LineCount += 1;
                    //-
